...
public class BookingController {
    ...
    public Booking refund(@PathVariable Long id) {
    ...
    public Booking extendBooking(@PathVariable Long id, @RequestParam int extraHours) {
        return service.extend(id, extraHours);
    }
